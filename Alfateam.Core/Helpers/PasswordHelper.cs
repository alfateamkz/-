...
namespace Alfateam.Core.Helpers
{
    ...
    {
        public static string GeneratePassword(int symbols)
        {
        ...
        {
            return PBKDF2HashHelper.CreatePasswordHash(password);
        }

        public static bool CheckEncryptedPassword(string password,string encrypted)
        {
           return PBKDF2HashHelper.VerifyPassword(password, encrypted);
        }
    }
