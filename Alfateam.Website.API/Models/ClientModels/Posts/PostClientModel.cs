...
namespace Alfateam.Website.API.Models.ClientModels.Posts
{
    ...
    public class PostClientModel : ClientModel
    {
        ...
        public static PostClientModel Create(Post post, int? langId)
        {
            ...
            {
                var localization = post.Localizations.FirstOrDefault(o => o.LanguageEntityId == langId);
        ...
        public static List<PostClientModel> CreateItems(IEnumerable<Post> items, int? langId)
        {
