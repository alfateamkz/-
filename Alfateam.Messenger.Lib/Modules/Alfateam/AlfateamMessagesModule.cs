...
{
    public class AlfateamMessagesModule : MessagesModule
    {
        private AlfateamMessenger Messenger;
        public AlfateamMessagesModule(AlfateamMessenger messenger)
        {
            Messenger = messenger;
        }
        ...
        public override async Task<Message> SendRecordingVoiceMessage(string chatId)
        {
            throw new NotImplementedException();
        }
