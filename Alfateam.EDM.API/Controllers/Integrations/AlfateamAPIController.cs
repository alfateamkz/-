...
using Alfateam.EDM.API.Models.DTO.Integrations.API;
using Alfateam.EDM.Models.Integrations.API;
using Alfateam.EDM.API.Models.Filters.Integrations;

namespace Alfateam.EDM.API.Controllers.Integrations
{
