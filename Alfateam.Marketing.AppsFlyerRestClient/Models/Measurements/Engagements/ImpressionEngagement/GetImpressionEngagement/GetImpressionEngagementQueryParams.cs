using Alfateam.Marketing.AppsFlyerRestClient.Enums.Measurements.Engagements.GetClickEngagement;
using Alfateam.Marketing.AppsFlyerRestClient.Enums.Measurements.Engagements.GetImpressionEngagement;
...
namespace Alfateam.Marketing.AppsFlyerRestClient.Models.Measurements.Engagements.ImpressionEngagement.GetImpressionEngagement
{
    public class GetImpressionEngagementQueryParams
    {
        ...
        public GetImpressionEngagementQueryParamsAfCampaignType AfCampaignType { get; set; }
        ...
        public GetImpressionEngagementQueryParamsAfAdType AfAdType { get; set; }
        ...
        public GetImpressionEngagementQueryParamsAfDeviceIdType AfDeviceIdType { get; set; }
