...
namespace Alfateam.Marketing.AppsFlyerRestClient.Models.Measurements.Engagements.ClickEngagement.GetClickEngagement
{
    public class GetClickEngagementQueryParams
    {
        ...
        public GetClickEngagementQueryParamsAfCampaignType AfCampaignType { get; set; }
        ...
        public GetClickEngagementQueryParamsAfAdType AfAdType { get; set; }
        ...
        public GetClickEngagementQueryParamsAfDeviceIdType AfDeviceIdType { get; set; }
