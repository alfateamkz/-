...
namespace Alfateam.Marketing.AppsFlyerRestClient.Models.Measurements.Engagements.ClickEngagement.ClickEngagementPost
{
    public class ClickEngagementPostBody
    {
        ...
        public ClickEngagementPostAfCampaignType AfCampaignType { get; set; }
        ...
        public ClickEngagementPostAfAdType AfAdType { get; set; }
        ...
        public ClickEngagementPostAfDeviceIdType AfDeviceIdType { get; set; }
