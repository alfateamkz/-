...
namespace Alfateam.Marketing.AppsFlyerRestClient.Models.RawDataReport.RawDataPull.AdRevenueRawData.RetargetingAdRevenue
{
    public class GetRetargetingAdRevenueQueryParams
    {
        [JsonProperty("from")]
