...
using Alfateam.Telephony.API.Models.DTO.Integrations.API;
using Alfateam.Telephony.Models.Integrations.API;
using Alfateam.Telephony.API.Models.SearchFilters.Integrations;

namespace Alfateam.Telephony.API.Controllers.Integrations
{
    [Route("Integrations/[controller]")]
    [RequiredRole(UserRole.Owner)]
    public class AlfateamAPIController : AbsAuthorizedController
    {
