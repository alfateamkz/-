...
using Alfateam.TicketSystem.Models.DTO.Integrations.API;
using Alfateam.TicketSystem.API.Models.Filters.Integrations;
using Alfateam.TicketSystem.API.Filters;
using Alfateam.TicketSystem.Models.Enums;

namespace Alfateam.TicketSystem.API.Controllers.Integrations
{
